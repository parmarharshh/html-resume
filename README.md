...
### Key Features:
* **No CSS:** All visual formatting is achieved through standard HTML attributes (e.g., `border="1"`, `<hr>`).
...
* **Structured Data:**
    ...
    * **Horizontal Rules:** Used `<hr>` tags to visually separate distinct sections.
